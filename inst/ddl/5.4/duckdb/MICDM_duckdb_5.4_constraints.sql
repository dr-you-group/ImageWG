...
ALTER TABLE @cdmDatabaseSchema.image_feature ADD CONSTRAINT fpk_image_feature_concept_id FOREIGN KEY (image_feature_concept_id) REFERENCES @cdmDatabaseSchema.CONCEPT (concept_id);
ALTER TABLE @cdmDatabaseSchema.image_feature ADD CONSTRAINT fpk_image_feature_type_concept_id FOREIGN KEY (image_feature_type_concept_id) REFERENCES @cdmDatabaseSchema.CONCEPT (concept_id);
ALTER TABLE @cdmDatabaseSchema.image_feature ADD CONSTRAINT fpk_image_finding_concept_id FOREIGN KEY (image_finding_concept_id) REFERENCES @cdmDatabaseSchema.CONCEPT (concept_id);
ALTER TABLE @cdmDatabaseSchema.image_feature ADD CONSTRAINT fpk_anatomic_site_concept_id FOREIGN KEY (anatomic_site_concept_id) REFERENCES @cdmDatabaseSchema.CONCEPT (concept_id);