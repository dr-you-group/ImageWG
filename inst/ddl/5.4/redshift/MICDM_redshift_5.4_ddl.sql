...
CREATE TABLE @cdmDatabaseSchema.image_occurrence  (image_occurrence_id integer NOT NULL, 
...
DISTKEY(person_id);
CREATE TABLE @cdmDatabaseSchema.image_feature (image_feature_id integer NOT NULL,
				 person_id integer NOT NULL,
